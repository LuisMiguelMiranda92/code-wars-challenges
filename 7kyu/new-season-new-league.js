...
// The key will be their position from last season and the value is the club's name e.g. Arsenal.

// The output should be an object ({}) with the key as the club's starting position for the 
// new season and the value should be club's name e.g. Arsenal.
