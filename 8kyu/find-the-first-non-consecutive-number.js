...
// elements will be numbers. The numbers will also all be unique
//  and in ascending order. The numbers could be positive or 
...
// [ x ] though? (This is an empty array and one with a single 
//     number and is not tested for, but you can write your own example test. )
